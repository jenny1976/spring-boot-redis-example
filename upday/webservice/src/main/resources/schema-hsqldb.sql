...
-- unique contraints
ALTER TABLE NEWS_ARTICLE_AUTHOR
    ADD CONSTRAINT unique_article_auth_combination
    unique(ARTICLE_ID, AUTHOR_ID)
;

ALTER TABLE NEWS_ARTICLE_KEYWORD
    ADD CONSTRAINT unique_article_kw_combination
    unique(ARTICLE_ID, KEYWORD_ID)
;

ALTER TABLE NEWS_KEYWORD
    ADD CONSTRAINT unique_keyword_name
    unique(NAME)
;
